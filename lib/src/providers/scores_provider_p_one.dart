...
class ScoresProviderPlayerOne {

  static final ScoresProviderPlayerOne _singleton = ScoresProviderPlayerOne._internal();

  ScoresProviderPlayerOne._internal() {
    resetScorePlayerOne();
    resetTotalScore();
  }

  factory ScoresProviderPlayerOne() => _singleton;
...
ScoresProviderPlayerOne scoresPlayerOne = new ScoresProviderPlayerOne();
